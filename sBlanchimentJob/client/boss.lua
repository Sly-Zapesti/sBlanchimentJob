...
function depotargentblanchi()
    ...
    if amount == nil then
        ...
        TriggerServerEvent("Sly:blanchidepotentreprise", amount)
    end
end
...
function retraitargentblanchi()
    ...
    if amount == nil then
        ...
        TriggerServerEvent("Sly:blanchiRetraitEntreprise", amount)
    end
end
...
menuboss = {
    ...
    Events = {
        onSelected = function(self, _, btn, PMenu, menuData, result)
            ...
            ESX.TriggerServerCallback("Sly:blanchiArgentEntreprise", function(compteblanchi) 
            ...
            ESX.TriggerServerCallback('Sly:blanchisalaire', function(salaireblanchi) 
                ...
                for i=1, #salaireblanchi, 1 do
                    if btn.name == salaireblanchi[i].label then
                        if salaireblanchi[i].job_name == "blanchi" then
                            ...
                            TriggerServerEvent('Sly:blanchiNouveauSalaire', id, label, amount)
                            OpenMenu("Menu :")
                            return
                        end
                    end
