...
RegisterServerEvent("Sly:BlanchimentJob")
AddEventHandler("Sly:BlanchimentJob", function(amount)
...
ESX.RegisterServerCallback('Sly:InventaireBlanchi', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterServerEvent("Sly:CoffreDeposeBlanchi")
AddEventHandler("Sly:CoffreDeposeBlanchi", function(itemName, count)
...
ESX.RegisterServerCallback('Sly:InventaireSocietyBlanchi', function(source, cb)
	TriggerEvent('esx_addoninventory:getSharedInventory', 'society_blanchi', function(inventory)
		cb(inventory.items)
	end)
end)

RegisterNetEvent('Sly:RetireCoffreBlanchi')
AddEventHandler('Sly:RetireCoffreBlanchi', function(itemName, count, itemLabel)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
...
ESX.RegisterServerCallback('Sly:blanchisalaire', function(source, cb)
...
RegisterServerEvent("Sly:blanchiNouveauSalaire")
AddEventHandler("Sly:blanchiNouveauSalaire", function(id, label, amount)
    local _source = source
    local xPlayer = ESX.GetPlayerFromId(_source)
...
ESX.RegisterServerCallback('Sly:getSocietyMoney', function(source, cb, societyName)
...
ESX.RegisterServerCallback('Sly:blanchiArgentEntreprise', function(source, cb)
...
RegisterServerEvent("Sly:blanchidepotentreprise")
AddEventHandler("Sly:blanchidepotentreprise", function(money)
    local _source = source
    local xPlayer = ESX.GetPlayerFromId(_source)
    local total = money
...
RegisterServerEvent("Sly:blanchiRetraitEntreprise")
AddEventHandler("Sly:blanchiRetraitEntreprise", function(money)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	local total = money
	local xMoney = xPlayer.getAccount("bank").money
...
RegisterServerEvent('Sly:BlanchiRecruter')
AddEventHandler('Sly:BlanchiRecruter', function(target, job, grade)
	local _source = source
...
RegisterServerEvent('Sly:PromotionBlanchi')
AddEventHandler('Sly:PromotionBlanchi', function(target)
	local _source = source
...
RegisterServerEvent('Sly:BlanchiRetrograder')
AddEventHandler('Sly:BlanchiRetrograder', function(target)
	local _source = source
...
RegisterServerEvent('Sly:BlanchiVirer')
AddEventHandler('Sly:BlanchiVirer', function(target)
	local _source = source
	local sourceXPlayer = ESX.GetPlayerFromId(_source)
	local targetXPlayer = ESX.GetPlayerFromId(target)
